...
public class ParseHelper {
    ...
    public Integer parsStringToInt(String value) {
        try {
            ...
            log.info("Found json value is integer, but the {} isn't parsable to integer, " +
    ...
    public Boolean parseStringToBoolean(String value) {
        if (value.equalsIgnoreCase("false") || value.equalsIgnoreCase("true")) {
            ...
            log.info("Found json value is boolean, but the {}, isn't boolean string, please set " +
    ...
    public Float parsStringToFloat(String value) {
        try {
            ...
            log.info("Found json value is float, but the {} isn't parsable to float, " +
    ...
    public Double parsStringToDouble(String value) {
        try {
            ...
            log.info("Found json value is double, but the {} isn't parsable to double, " +
    ...
    public BigInteger parsStringToBigint(String value) {
        try {
            ...
            log.info("Found json value is BigInteger, but the {} isn't parsable to BigInteger, " +
