...
public class ResponseBodyHelper {
    ...
    protected String getResponseAsString() throws NullResponse {
        ...
        try {
            ...
            log.info("Response could not get as String \n Exception detail:\n {}", e.getMessage());
            throw e;
        }
    }
    ...
    private JsonPath getResponseAsJsonPath() throws NullResponse {
        ...
        try {
            ...
            log.info("Response could not get as JsonPath \n Exception detail:\n {}", e.getMessage());
            throw e;
        }
    }
    ...
    private XmlPath getResponseAsXmlPath() throws NullResponse {
        ...
        try {
            ...
            log.info("Response could not get as XmlPath \n Exception detail:\n {}", e.getMessage());
            throw e;
        }
    }
    ...
    protected Object getJsonPathValue(String selector) throws NullResponse {
        try {
            ...
            log.info("Json element could not find by {} \n Exception detail:\n {}", selector, e.getMessage());
            throw e;
        }
    }
    ...
    protected String getXmlPathValue(String selector) throws NullResponse {
        try {
            ...
            log.info("Xml element could not find by {} \n Exception detail:\n {}", selector, e.getMessage());
            throw e;
        }
